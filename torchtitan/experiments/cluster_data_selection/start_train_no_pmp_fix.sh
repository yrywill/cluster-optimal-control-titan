...
# ============================================================
# TorchTitan Llama3-3B Training (NO PMP, random within-bucket, size-proportional weights)
...
#
# Env override:
#   TRAIN_LR=1e-4 TRAIN_STEPS=2000 bash start_train_no_pmp_fix.sh
# ============================================================
...
DUMP_FOLDER=${DUMP_FOLDER:-"/apdcephfs_jn5/share_304380933/rongyiyu/output/train_no_pmp_fix"}
...
echo "============================================================"
echo " Llama3-3B Training (NO PMP, within-bucket RANDOM sampling)"
echo "============================================================"
...
echo " Within-bucket order: random (each rank has independent RNG)"
echo " Initial weights: proportional to cluster_size"
...
TRAIN_ARGS=(
    ...
    # Checkpoint (DCP only, no HF conversion)
    ...
    # Disable PMP (sample proportional to cluster size)
